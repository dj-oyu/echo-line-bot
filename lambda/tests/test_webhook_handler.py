...
class TestWebhookHandler(unittest.TestCase):
    ...
    @patch("webhook_handler.get_bot_user_id")
    def test_handle_message_regular_message_group(
        self,
        mock_get_bot_id,
        mock_start_ai,
        mock_get_context,
    ...
    @patch("webhook_handler.get_conversation_context")
    @patch("webhook_handler.start_ai_processing")
    def test_handle_message_direct_chat(
        self, mock_start_ai, mock_get_context, mock_save_context, mock_stepfunctions
    ):
